...
idir = "R:\\UnitedStates\\ForDRI_project-NEW\\Case_Study_2022_Growing_Season\\eMODIS_NDVI_V6\\"
NDVI_list = glob.glob(idir+"*.tif")
NDVI_list.sort()
ndvi_file = "R:\\UnitedStates\\ForDRI_project-NEW\\New_Model_2022\\INPUT_NEW_DATA_2022\\NDVI\\NDVI_200901.tif" #load reference file
...
out_prj = "R:\\UnitedStates\\ForDRI_project-NEW\\Case_Study_2022_Growing_Season\\NDVI\\NDVI_prj\\"
...
for f in NDVI_list:
    ...
    arcpy.ProjectRaster_management(f, out_prj+fname, t_prj, "BILINEAR", cellsize,"#" , "#", s_prj, "#")
    print(fname)
